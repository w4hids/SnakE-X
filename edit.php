...
<body>
    ...
    <div class="container">
        ...
        if(isset($_POST['submit'])){
            ...
            $edit_query = mysqli_query($conn, "UPDATE users SET username = '$username', email = '$email' WHERE Id = '$id'") or die("Error Occured");
        ...
        ?>
            ...
            <form action="" method="post">
                ...
                <div class="field">
                    <input type="submit" class="btn" name="submit" value="Upadte" required>
                </div>
